...
{
  int PassnNo; // busNo0SeatNo. // passenger number to traverse through the tree
  char name[10];
...
int busSeat[32][9] = {0}; //it means 9 buses and 32 seats in each bus
...
BST *insert(BST **r, int custId) // insert into a bst using passno as the reference
{
  if (*r == NULL)
  {
